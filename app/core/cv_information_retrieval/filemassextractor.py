...
class FileMassExtractor:
    ...
    read_all_documents(self, directory: str) -> list[dict]: To read documents without saving
    read_dump_and_copy_all_files(self, directory: str): To read documents and save .Txt
    ...
    def read_all_documents(
        ...
        collab_ids: 
            ...
            Enables tracking the name of the user (collab_id) which is assigned to each file
    ...
    # internal functions
    # =============================================================================
    def _filter_extensions(self, file_paths: list[str], read_only_extensions=None, ignore_extensions=None) -> list[str]:
        """
        ...
        -------
        list
            A list of filtered file paths based on the provided exclusion/inclusion criteria.
        """
        ...
        if read_only_extensions:
            filtered_file_paths = [
                ...
                if PathExplorer.get_single_file_extension(file_path) in read_only_extensions
            ]
        ...
        if ignore_extensions:
            filtered_file_paths = [
                file_path for file_path in file_paths
                if PathExplorer.get_single_file_extension(file_path) not in ignore_extensions
            ]
            return filtered_file_paths
