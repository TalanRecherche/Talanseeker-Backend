...
class Chunker:
    ...
    def _split_string_approx(
        ...
        The function attempts to cut at triple, double and single linebreaks
        (with priority)
        This is just an attempt at replacing Lanchain's garbage text splitters which
        don't work
        ...
        while start < len(text):
            if end < len(text):
                # Find the nearest triple, double, or single line break within
