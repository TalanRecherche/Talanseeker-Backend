    ...
    def upsert(row: pd.Series, table_name: str, policy: str) -> None:
        ...
        if policy == UpsertPolicies.PROFILE_UPDATE:
            ...
            if len(data) == 0:
                ...
                useless_cols = [
                    STRUCTCV_DF.cv_id,
                    STRUCTCV_DF.file_path,
                    STRUCTCV_DF.file_name,
                    STRUCTCV_DF.file_extension,
                    STRUCTCV_DF.file_full_name,
                ]
