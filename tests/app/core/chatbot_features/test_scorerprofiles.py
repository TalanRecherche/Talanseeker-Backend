...
def test_score_by_keywords_columns(setup_data):
    ...
    expected_cols = ['collab_id', 'years', 'diplomas_certifications', 'roles', 'sectors',
                     'companies', 'soft_skills', 'technical_skills', 'keywords_score']
...
def test_assign_scores_to_profiles_columns(setup_data):
    ...
    expected_cols = ['collab_id', 'years', 'diplomas_certifications', 'roles', 'sectors',
                     'companies', 'soft_skills', 'technical_skills', 'keywords_score',
                     'semantic_score', 'keywords_score_normalized',
