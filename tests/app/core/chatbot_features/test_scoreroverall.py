...
from app.core.models.scoredprofiles_pandasmodels import SCORED_CHUNKS_DF, SCORED_PROFILES_DF
...
def test_get_overall_scores_chunks_columns(setup_data):
    ...
    df_chunks_scored, _ = scorer.get_overall_scores(df_chunks,
                                                    df_profiles,
                                                    query_keywords,
                                                    query_embeddings)
...
def test_get_overall_scores_profiles_columns(setup_data):
    ...
    scorer = ScorerOverall()
    _, df_profiles_scored = scorer.get_overall_scores(df_chunks,
                                                      df_profiles,
                                                      query_keywords,
                                                      query_embeddings)
