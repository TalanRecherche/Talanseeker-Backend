...
def setup_data():
    ...
    candidates_chunks, candidates_collabs, _, candidates_profiles = selector.select_candidates(df_chunks,
                                                                                               df_collabs,
                                                                                               df_cvs,
                                                                                               df_profiles,
                                                                                               df_query)
    ...
    response, query_sent = chatbot.get_chatbot_response(df_query,
                                                        candidates_chunks,
                                                        candidates_collabs,
                                                        candidates_profiles)
